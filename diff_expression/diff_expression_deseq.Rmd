...
deseq_diff_expr_results %>%
  dplyr::filter((dataset == "transcript") & (comparison == config$contrasts[[7]]) & (pipeline == "rnaseq")) %>%
  MA_interactive()
```
...
deseq_diff_expr_results %>%
  dplyr::filter((dataset == "gene") & (comparison == config$contrasts[[7]]) & (pipeline == "rnaseq")) %>%
  MA_interactive()
```
...
deseq_diff_expr_results %>%
  dplyr::filter((dataset == "transcript") & (comparison == config$contrasts[[8]]) & (pipeline == "rnaseq")) %>%
  MA_interactive()
```
...
deseq_diff_expr_results %>%
  dplyr::filter((dataset == "gene") & (comparison == config$contrasts[[8]]) & (pipeline == "rnaseq")) %>%
  MA_interactive()
```
...
deseq_diff_expr_results %>%
  dplyr::filter((dataset == "transcript") & (comparison == config$contrasts[[9]]) & (pipeline == "rnaseq")) %>%
  MA_interactive()
```
...
deseq_diff_expr_results %>%
  dplyr::filter((dataset == "gene") & (comparison == config$contrasts[[9]]) & (pipeline == "rnaseq")) %>%
  MA_interactive()
```
...
deseq_diff_expr_results %>%
  dplyr::filter((dataset == "transcript") & (comparison == config$contrasts[[10]]) & (pipeline == "rnaseq")) %>%
  MA_interactive()
```
...
deseq_diff_expr_results %>%
  dplyr::filter((dataset == "gene") & (comparison == config$contrasts[[10]]) & (pipeline == "rnaseq")) %>%
  MA_interactive()
```
