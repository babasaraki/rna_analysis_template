...
fig_height_transcript_rnaseq <- base::nrow(log_counts_per_million$lcpm_transcript_rnaseq_data) / 6
fig_height_gene_rnaseq <- base::nrow(log_counts_per_million$lcpm_gene_rnaseq_data) / 6
