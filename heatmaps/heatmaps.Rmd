...
raw_datasets <- base::list(transcript_rnaseq = raw_transcript_rnaseq_data,
                           gene_rnaseq = raw_gene_rnaseq_data)

lcpm_datasets <- base::list(transcript_rnaseq = lcpm_transcript_rnaseq_data,
                            gene_rnaseq = lcpm_gene_rnaseq_data)
...
sig_gene_transcripts <- diff_expr_results %>%
  ...
  dplyr::pull(unique(gene_transcript))
...
fig_height_transcript_rnaseq <- base::nrow(log_counts_per_million$transcript_rnaseq) / 6
fig_height_gene_rnaseq <- base::nrow(log_counts_per_million$gene_rnaseq) / 6

fig_height_transcript_rnaseq_free <- base::nrow(log_counts_per_million$transcript_rnaseq) / 4
fig_height_gene_rnaseq_free <- base::nrow(log_counts_per_million$gene_rnaseq) / 4
...
# extract datasets
lcpm_transcript_rnaseq <- log_counts_per_million$transcript_rnaseq
...
# extract datasets
lcpm_gene_rnaseq <- log_counts_per_million$gene_rnaseq
