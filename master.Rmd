...
*This will check for some common issues in the input configuration/metadata/raw count data. Please address any issues flagged before continuing.*

```{r, warning = FALSE}
base::source("./sanity_check_inputs/sanity_check_inputs.R")
```
